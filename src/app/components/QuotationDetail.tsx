...
export function QuotationDetail() {
  ...
  return (
    <div style={{ maxWidth: 920, margin: '0 auto', padding: '24px 16px' }}>
      ...
      <div id="quotation-document" style={{ backgroundColor: 'white', borderRadius: 0, overflow: 'hidden', boxShadow: 'none', maxWidth: 1040, margin: '0 auto', fontFamily: 'Arial, Helvetica, sans-serif', padding: 18 }}>

        <div className="print-keep" style={{ display: 'grid', gridTemplateColumns: '330px 1fr', gap: 18, alignItems: 'start' }}>
          <div>
            <img src={logoImg} alt="SURTIMAX" style={{ width: 295, objectFit: 'contain', marginBottom: 22 }} />
            <div style={{ display: 'flex', gap: 28, fontSize: 33, marginLeft: 28, marginTop: 6 }}>
              <span>AMBIENTE</span><span>PRODUCCIÓN</span>
            </div>
            <div style={{ marginTop: 34, marginLeft: 28, fontSize: 37 }}><strong>No. Prefactura:</strong></div>
          </div>

          <div>
            <h1 style={{ margin: 0, fontSize: 53, letterSpacing: 0.3, fontWeight: 800 }}>DISTRIBUIDORA & COMERCIALIZADORA</h1>
            <div style={{ fontSize: 40, lineHeight: 1.35, marginTop: 10 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', marginTop: 70, alignItems: 'start' }}>
              <div />
              <div style={{ fontSize: 41, lineHeight: 1.45 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '220px 1fr', columnGap: 18, rowGap: 6, fontSize: 40, marginTop: 28 }}>
        ...
        <div style={{ marginTop: 10 }}>
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 31 }}>
            <thead>
              <tr>
            ...
            <tbody>
              ...
              <tr><td colSpan={8} style={{ ...bigTd, height: 540, borderTop: 'none' }} /></tr>
            </tbody>
          </table>
        </div>

        <div className="print-keep" style={{ marginTop: 12, display: 'grid', gridTemplateColumns: '1fr 380px', gap: 10 }}>
          <div style={{ border: '1px solid #000', minHeight: 95, padding: '8px 10px', fontSize: 35 }}>OBSERVACION:</div>
          <div style={{ border: '1px solid #000', padding: '10px 14px', fontSize: 37 }}>
        ...
        <div className="print-keep" style={{ marginTop: 18, fontSize: 32, lineHeight: 1.35, padding: '0 4px' }}>
          Cordiales y su distribuidor garantizan el adecuado tratamiento de sus datos personales conforme a la ley. Sus datos serán usados para procesar transacciones, enviar comunicaciones comerciales y gestionar la relación comercial, según nuestra política de privacidad en nuestro portal web. Usted puede consultar y ejercer sus derechos de acceso, rectificación, cancelación y oposición escribiéndonos a GQ_SurtiMax@outlook.com.
        </div>
      </div>
      </div>
      </div>
